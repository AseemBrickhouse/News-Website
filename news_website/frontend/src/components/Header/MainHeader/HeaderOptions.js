...
import { Typography, Popover, Box, Button, MenuItem } from "@material-ui/core";
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(HeaderOptions)
);
