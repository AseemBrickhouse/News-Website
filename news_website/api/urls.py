...
urlpatterns = [
        ...
        path("account/<str:account_id>/comments/<str:article_id>", GetUserComments.as_view(), name='user-comments-article'),
        ...
        #Child Comments
        path("articles/<str:article_id>/comments/<str:comment_id>/children/", ChildComments.as_view(), name='article-child-comments'),

        #Parent Comment given a child
        path("articles/<str:article_id>/comments/<str:comment_id>/parent/",ParentComments.as_view(), name='article-parent-comments'),
